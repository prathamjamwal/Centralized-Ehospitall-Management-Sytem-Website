...
<body>
	...
	<form method="POST">
		<div class="container">
            ...
            <label for="doctor-category">Select a category of doctor:</label>
<select id="doctor-category" name="doctor-category">
...
<label for="password1"><b>Date Of Birth</b></label>
			...
			<label for="email1"><b>Hospital <span>*</span></b></label>
    ...
    if (!validateEmail(email)) {
        ...
        <?php
         if (isset($_POST['name']) &&  isset($_POST['email']) && isset($_POST['password'])&& isset($_POST['doctor-category']) ) {
            if (empty($_POST['name']) || empty($_POST['email']) || empty($_POST['password']) || empty($_POST['doctor-category'])) {
                $_SESSION['error'] = "All fields are required";
                header("Location: registerdoc.php");
                return;
            }
            ...
            $sql = "INSERT INTO citizenlog ( email, pass, name , specialization,dob,hospital) VALUES (:em,:pa, :fn,:sp,:dob,:hos)";
